---
title: "Rotina para avaliação de projeto de energia usando opcoes reais - Quarto (usando o Quarto)"
format: 
  html:
    df-print: kable
editor: visual
...
# 7- Analisando o critério de opções reais

```{r}
cat("S ", format(S, nsmall = 2))
cat("K", format(K, scientific = FALSE, nsmall = 2))
